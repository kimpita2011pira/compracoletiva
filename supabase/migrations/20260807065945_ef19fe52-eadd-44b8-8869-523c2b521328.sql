...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'no dia 21/07 houve reserva de uma oferta pelo usuário compracoletivapira@gmail.com, a oferta não foi efetivada e o valor (R$ 10,00) não voltou para sua carteira.';
  END CASE;
