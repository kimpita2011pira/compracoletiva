...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Adicionar um registro de reembolso para cada oferta cancelada, incluindo status (pendente/processado/falhou), valores e identificador da execução no banco.';
  END CASE;
