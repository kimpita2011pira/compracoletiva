...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Implementar testes de integração para validar que o valor é reservado no pagamento, estornado corretamente quando a oferta não é efetivada e transferido ao vendedor após a efetivação, com a comissão de 10% para a carteira do adm.';
  END CASE;
