...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'CARTEIRA NÃO ESTÁ FUNCIONANDO CORRETAMENTE, USUÁRIO COMPRACOLETIVAPIRA@GMAIL.COM REALIZOU RESERVA DE OFERTA DO VENDEDOR KIMPITA2011@GMAIL.COM, O VALOR FOI DEBITADO DA CARTEIRA DO COMPRADOR MAIS NÃO ENTROU NA CARTEIRA DO VENDEDOR E NEM OS 10% DA TX DE ADM NA CARTEIRA DO ADM.';
  END CASE;
...
GRANT EXECUTE ON FUNCTION public.notify_customers_on_offer_validation() TO authenticated;
GRANT EXECUTE ON FUNCTION public.notify_customers_on_offer_validation() TO service_role;
