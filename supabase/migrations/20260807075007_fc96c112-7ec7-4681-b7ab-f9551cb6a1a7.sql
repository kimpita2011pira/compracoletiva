...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Planejar a estrutura da nova tela de administração para reembolsos.

Implementar os filtros de período e oferta na interface do administrador.Desenvolver uma tela no admin para listar ofertas canceladas e acompanhar o status de cada estorno, com filtros por período e oferta.';
  END CASE;
