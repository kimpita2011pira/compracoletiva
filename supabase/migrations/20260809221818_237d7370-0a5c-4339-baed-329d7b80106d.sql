...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Implementar uma tela no AdminDashboard para listar ofertas canceladas e acompanhar o status de cada estorno associado às reservas. Criar uma trilha de auditoria para registrar quando cada estorno foi processado e o motivo do cancelamento, incluindo o saldo antes e depois.';
  END CASE;
