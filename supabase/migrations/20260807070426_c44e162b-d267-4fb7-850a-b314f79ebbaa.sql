...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Testar o fluxo de cancelamento de oferta ponta a ponta para confirmar que a notificação e o estorno de R$ 10,00 aparecem corretamente na carteira.';
  END CASE;
