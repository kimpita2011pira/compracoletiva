...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Prosseguir com a implementação técnica das rotinas de reconciliação periódica.

Validar se as notificações disparadas por cancelamento de oferta exibem o novo texto.';
  END CASE;
