...
BEGIN
  ...
  CASE NEW.status
    ...
    WHEN 'CANCELADA' THEN
      ...
      v_message := 'Investigar a causa raiz da falha na distribuição dos valores (10% admin e 90% vendedor) durante a validação da oferta para garantir a integridade financeira.';
  END CASE;
